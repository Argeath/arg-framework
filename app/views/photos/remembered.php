<article>
    ...
    <h2>Galeria zdjęć</h2>
    <div class="photos">
        <form method="post" action="/index.php/photos/forget">
            <?php foreach($photos as $photo): ?>
                <div class="photo">
                    <a href="/assets/uploads/<?= $photo->bigPath; ?>"><img src="/assets/uploads/<?= $photo->smallPath; ?>"/></a><br />
                    <input type="checkbox" name="remember_photo_<?= $photo->_id; ?>" value="Y"/>
            ...
            <button class="btn">Zapomnij zdjęcia</button><br /><br /><br />
        </form>
    </div>
</article>